...
Requires three repo settings (see the comment at the top of the workflow):
`CLOUDFLARE_API_TOKEN` and `CLOUDFLARE_ACCOUNT_ID` as secrets, `CF_PAGES_PROJECT` as a variable.
